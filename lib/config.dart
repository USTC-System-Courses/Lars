...
String opString = r"(^|\s+)(add\.w|sub\.w|slt|sltu|nor|and|or|xor|sll\.w|srl\.w|sra.w|mul.w|mulh\.w|mulhu\.w|div\.w|mod\.w|divu\.w|modu\.w|slli\.w|srli\.w|srai\.w|slti|sltiu|addi\.w|andi|ori|xori|lu12i\.w|pcaddu12i|ld\.b|ld\.h|ld\.w|st\.b|st\.h|st\.w|ld\.bu|ld\.hu|jirl|b|bl|beq|bne|blt|bge|bltu|bgeu|break|li\.w|la\.local)";
